...
(function() {
  ...
  defaultExts = ['html', 'css', 'js', 'png', 'gif', 'jpg', 'php', 'php5', 'py', 'rb', 'erb', 'coffee','ftl'];
  ...
  Server = (function() {
    ...
    Server.prototype.listen = function() {
      this.debug("hmreload is waiting for browser to connect.");
  ...
  exports.createServer = function(config) {
    ...
    requestHandler = function(req, res) {
      if (url.parse(req.url).pathname === '/livereload.js') {
        ...
        return res.end(fs.readFileSync(__dirname + '/../ext/vendor/livereload-js/dist/livereload.js'));
      }
    };
    //这个server是如果没有用插件，而是在页面上嵌入的代码，那么会加载ext中的livereload.js
